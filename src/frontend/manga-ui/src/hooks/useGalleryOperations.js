...
export default function useGalleryOperations({ albumConfig, paged, pageTotal,
  ...
  return {
    ...
    handleOpenReader,
    importModal, setImportModal, importForm, setImportForm, importing, setImporting,
    ...
    batchImporting, setBatchImporting, batchImportResult, setBatchImportResult, handleBatchImport,
    editTagsModal, setEditTagsModal, editTagsForm, setEditTagsForm,
    editTagsSaving, setEditTagsSaving, loadEditTags, saveEditTags,
  }
}
